      ...
      >
        ...
        <Animated.View style={[styles.welcomeSection, animatedTitleStyle]}>
          ...
          <Text style={styles.welcomeDescription}>
            Connect with your campus community to get tasks done and earn money.
          </Text>
        </Animated.View>
      ...
      <Animated.View style={[styles.bottomSection, animatedContentStyle, { paddingBottom: insets.bottom + 20 }]}>
        ...
        <View style={styles.legalSection}>
          <Text style={styles.legalDisclaimer}>
            ...
            <Text style={styles.legalLink} onPress={handleTerms}>Terms of Service</Text>
            {' '}and{' '}
            <Text style={styles.legalLink} onPress={handlePrivacy}>Privacy Policy</Text>.
          </Text>
